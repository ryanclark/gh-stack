...
<CardGrid>
  ...
  <Card title="AI Agent Integration" icon="puzzle">
    Run `npx skills add ryanclark/gh-stack` to teach your AI coding agents how to work with stacks. Break up a large diff into a stack or develop with stacks from the start.
  </Card>
</CardGrid>
